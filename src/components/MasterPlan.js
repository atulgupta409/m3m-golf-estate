          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-8">
              ...
              <p className="w-75">
                ...
                Hansen Associates- London. The club will have amenities
                comparable to a <b>7- Star Resort</b> including International
                Spa, Private Art Gallery, Unisex Gym and Salon, multi-cuisine
                restaurants and multiple recreational areas. Designer{" "}
                ...
                basketball courts, amphitheatre, rock climbing, and numerous
                such zones.
              </p>
            </div>
          </div>
